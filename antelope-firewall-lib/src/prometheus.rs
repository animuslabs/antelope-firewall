...
lazy_static! {
    ...
    pub static ref CLIENT_ERROR_NODE_RESPONSES: GenericCounter<AtomicF64> = register_counter!("node_responses_error", "Node responses that had 4** errors").unwrap();
    pub static ref SERVER_ERROR_NODE_RESPONSES: GenericCounter<AtomicF64> = register_counter!("node_responses_error", "Node responses that had 5** errors").unwrap();
